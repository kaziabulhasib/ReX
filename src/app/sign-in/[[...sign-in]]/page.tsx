...
const SignInPage = () => {
  return (
    <div className='h-screen flex items-center justify-between  p-8'>
      <div className='hidden lg:flex w-1/2 align-center justify-center'>
        <svg
      ...
      <div className='w-full lg:w-1/2 flex flex-col gap-4'>
        <h1 className='text-2xl xsm:text-3xl md:text-6xl font-bold'>
          Happening now
        </h1>
        ...
        <SignIn.Root>
          ...
          <SignIn.Step name='start'>
            <Clerk.Field name='identifier' className='flex flex-col gap-4'>
              <Clerk.Input
          ...
          <SignIn.Step
            ...
            <SignIn.SupportedStrategy name='reset_password_email_code'>
              <span className='text-iconBlue underline'>Reset Password</span>
